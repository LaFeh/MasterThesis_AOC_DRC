...
# ── 1. Clean recompile ────────────────────────────────────────────────────────
try(dyn.unload(dynlib("./tmb_try/leroux_with_priors_wo_constraint")), silent = TRUE)
file.remove("./tmb_try/leroux_with_priors_wo_constraint.o")
file.remove("./tmb_try/leroux_with_priors_wo_constraint.dll")

compile("./tmb_try/leroux_with_priors_wo_constraint.cpp")
dyn.load(dynlib("./tmb_try/leroux_with_priors_wo_constraint"))
...
obj <- MakeADFun(
  ...
  DLL        = "leroux_with_priors_wo_constraint",
  silent     = FALSE
)
